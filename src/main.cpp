...
main() {
    ...
    variant<bool, DeepThoughtError> res1 = deepThought.processInput("Hello, World?");
    ...
    variant<bool, DeepThoughtError> res2 = deepThought.processInput("Hello, World?       \"Hello, Sir!\"    asd    \"How are you today?\"");
